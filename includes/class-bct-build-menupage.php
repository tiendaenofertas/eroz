...
class BCT_Build_Menupage {
    ...
    public function add_menu_eroz_page( $pageTitle, $menuTitle, $capability, $menuSlug, $functionName, $iconUrl = '', $position = null ) {
    ...
    public function add_submenu_eroz_page( $parentSlug, $pageTitle, $menuTitle, $capability, $menuSlug, $functionName ) {

        ...
        <div class="Page Row DX Nsp <?php echo eroz_position_sidebar(); ?>">
            ...
            <main>
                ...
                <section class="Eroz-Thumbs List">
                    <div class="page-top">
                        <h3 class="page-header"><?php single_cat_title(); ?></h3>
                    </div> 
                    ...
                    <?php if(have_posts()) : while(have_posts()) : the_post(); get_template_part( 'public/templates/loop', 'principal' ); endwhile; ?>
                    <div class="numeration">
                        <nav class="navigation pagination" role="navigation"> <?php eroz_pagination(); ?> </nav>
                    </div> <?php else: ?> <div> <?php _e('No articles', 'eroz'); ?> </div> <?php endif; ?>
                </section>
            </main>
